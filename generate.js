...
<section class="ps">
  <div class="wrap">
    <div class="blk reveal">
      <h2>El Problema</h2>
      <p>Tienes una idea y no sabes por donde empezar. Tienes trabajo atrasado y necesitas retomarlo. Te falta tiempo para una entrega. Quieres armar un proyecto y no tienes personal suficiente.</p>
    </div>
    <div class="blk reveal">
      <h2>La Solucion</h2>
      <p>Te ofrecemos <b>20 anos de experiencia</b> en diseno y construccion, trabajando con estudios de arquitectura y arquitectos freelance. Desarrollamos proyectos desde la idea hasta su documentacion para entrega a clientes y entidades gubernamentales.</p>
    </div>
  </div>
</section>
...
<section class="about" id="sobre">
  <div class="wrap about-in reveal">
    <div>
      ...
      <p>Somos un equipo con mas de 20 anos de experiencia en representacion de ideas y desarrollo de proyectos. Nos ajustamos a tus necesidades y a tu presupuesto.</p>
    </div>
